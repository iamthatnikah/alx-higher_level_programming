...
Project done during **Full Stack Software Engineering studies** with **ALX Online School**. It aims to learn about docstrings to create and implement tests in **Python**.
